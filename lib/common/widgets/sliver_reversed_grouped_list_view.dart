...
// class SliverReversedGroupedListView<T, E> extends StatefulWidget {
...
//   /// Creates a [SliverReversedGroupedListView]
//   SliverReversedGroupedListView({
//     Key? key,
...
//       _SliverReversedGroupedListViewState<T, E>();
// }

// class _SliverReversedGroupedListViewState<T, E>
//     extends State<SliverReversedGroupedListView<T, E>> {
...
//           var curr = widget.groupBy(_sortedElements[actualIndex - 1]);
//           var prev = widget.groupBy(_sortedElements[
//               actualIndex - 2 < 0 ? actualIndex : actualIndex - 2]);
//           if (prev != curr) {
//             return _buildGroupSeparator(_sortedElements[actualIndex - 1]);
//           }
//           return widget.separator;
//         }
//         return _buildItem(context, actualIndex);
//       }, childCount: _sortedElements.length * 2 + 1),
//     );
//   }
