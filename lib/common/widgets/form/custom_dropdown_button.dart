...
const EdgeInsets _kMenuItemPadding = EdgeInsets.only(left: 18.0, right: 16.0);
...
class _DropdownMenuPainter extends CustomPainter {
  _DropdownMenuPainter({
    ...
    required this.getSelectedItemOffset,
          ...
          borderRadius:
              dropdownDecoration?.borderRadius ?? BorderRadius.circular(2.0),
          boxShadow: [
    ...
    Widget child = FadeTransition(
      ...
      child: InkWell(
        ...
        child: Ink(
          ...
          decoration: widget.itemIndex == 0
              ? BoxDecoration(
                  color: isSelected ? const Color(0xFF4C5BD4) : null,
                  borderRadius: const BorderRadius.only(
                      // topLeft: Radius.circular(10.0),
                      // topRight: Radius.circular(10.0),
                      ),
                )
              : widget.itemIndex == widget.route.items.length - 1
                  ? BoxDecoration(
                      color: isSelected ? const Color(0xFF4C5BD4) : null,
                      borderRadius: const BorderRadius.only(
    ...
    final List<Widget> children = <Widget>[
      for (int itemIndex = 0; itemIndex < route.items.length; ++itemIndex)
        _DropdownMenuItemButton<T>(
          ...
          // can pass length --> change border radius
        ),
    ];
...
class _DropdownRoute<T> extends PopupRoute<_DropdownRouteResult<T>> {
  ...
  _MenuLimits getMenuLimits(
    ...
    double menuTop = (buttonTop - selectedItemOffset) -
        (itemHeights[selectedIndex < 0 ? 0 : selectedIndex] -
                buttonRect.height) /
            2.0;
...
class CustomDropdownButton<T> extends StatefulWidget {
  ...
  CustomDropdownButton({
    ...
    this.onTap,
    this.elevation = 6,
    this.textStyle = AppTextStyles.dropdownItem,
    this.icon,
...
class _CustomDropdownButtonState<T> extends State<CustomDropdownButton<T>>
  ...
  void _handleTap() {
    ...
    final Rect itemRect = itemBox.localToGlobal(Offset(0, 20),
    ...
    if (items.isEmpty) {
      ...
      innerItemsWidget = Container(
        ...
        decoration: const BoxDecoration()
            .copyWith(borderRadius: widget.decoration.borderRadius),
        child: IndexedStack(
