...
class CustomExpandsionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const CustomExpandsionTile({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  State<CustomExpandsionTile> createState() => CustomExpandsionTileState();
}

class CustomExpandsionTileState extends State<CustomExpandsionTile>
