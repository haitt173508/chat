...
class EditVoteScreen extends StatefulWidget {
  const EditVoteScreen({Key? key}) : super(key: key);

  @override
  State<EditVoteScreen> createState() => _EditVoteScreenState();
}
...
class _EditVoteScreenState extends State<EditVoteScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text('Sửa bình chọn'),
        centerTitle: true,
        actions: [
          TextButton(
            onPressed: () => AppRouter.backToPage(context, AppPages.Meeting_Screen),
        ...
        child: ListView(
          ...
          children: [
            ...
            TextButton(
              ...
              child: Row(
                children: [
                  SvgPicture.asset(Images.ic_plus,color: AppColors.primary,),
                  Expanded(
                    child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Không có thời hạn',
                    style:
                    context.theme.chatConversationDropdownTextStyle.copyWith(fontSize: 14),
                  ),
                  Divider(thickness: 1,),
                  Row(
                    children: [
