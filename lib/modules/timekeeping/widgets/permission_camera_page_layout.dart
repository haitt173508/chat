...
class PermissionCameraPageLayout extends StatefulWidget {
  const PermissionCameraPageLayout({
    Key? key,
    required this.title,
    required this.text,
  ...
  @override
  State<PermissionCameraPageLayout> createState() => _PermissionCameraPageLayoutState();
}

class _PermissionCameraPageLayoutState extends State<PermissionCameraPageLayout> with WidgetsBindingObserver {
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Image.asset(Images.img_camera),
            ),
            widget.text,
